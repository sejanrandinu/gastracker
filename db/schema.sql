...
CREATE TABLE IF NOT EXISTS updates (
  ...
  item_type TEXT CHECK(item_type IN ('litro', 'laugfs', 'petrol', 'petrol_92', 'petrol_95', 'diesel', 'auto_diesel', 'super_diesel', 'kerosene')) NOT NULL,
...
('u2', 's2', 'petrol_92', 'very_long', 'https://placeholder.com/photo2');
